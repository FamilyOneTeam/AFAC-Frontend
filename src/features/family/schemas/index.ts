...
export const MentoringTopics = z.enum([
  "Capacitación",
]);
export type MentoringTopics = z.infer<typeof MentoringTopics>;


export const requestFormSchema = z
.object({
    nombre: z.string(),
    fecha_de_mentoria: z.string(),
    tema_de_mentoria: MentoringTopics,
    mensaje: z.string(),
  });