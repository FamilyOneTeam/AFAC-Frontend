...
import FamilyFormTabs from "./form-tabs";
        ...
        <div className="relative w-full h-full md:h-auto flex items-center justify-center p-4">
          ...
          <div className="w-[97%] md:max-w-fit bg-white rounded-sm shadow-lg max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 border-b flex items-center justify-between shrink-0">
              <h3 className="font-semibold text-lg md:text-xl">Familia #</h3>
              <Button
                onClick={() => setEditFamily(false)}
                type="button"
            ...
            <div className="p-6 overflow-y-auto">
              <div className="grid gap-6">
                <FamilyFormTabs setForm={setForm} form={form} />
                <FamilyForm showForm={form} />
              </div>
            </div>
          </div>
        </div>
